...
5. **생성·검증 분리:** [`verify-change`](../verify-change/SKILL.md) **독립 검증 계약**을 따른다 (handoff → `qa-agent` → Gate 3). 횡단 패키지·공유 모듈은 [`docs/qa/integration-consumption-gate.md`](../../../docs/qa/integration-consumption-gate.md) 소비 증거를 포함한다.
